                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Number Of Consumers</th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1">Customer Type</th>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">Number Of Consumers</th>
                                        <th rowspan="1" colspan="1">Customer Type</th>
